...
CXXFLAGS=-Zi -TP -MP -W4 -wd4244 -wd4189 -Zc:forScope -Zc:wchar_t -D_CRT_SECURE_NO_DEPRECATE=1 -D_CRT_NONSTDC_NO_DEPRECATE /std:c++14 $(WIDEFLAGS) $(XP_DEFINE)
CCFLAGS=-TC -MP -W3 -wd4244 -D_CRT_SECURE_NO_DEPRECATE=1 -DLUA_COMPAT_5_1 -DLUA_COMPAT_BITLIB -DLUA_USER_H=\"scite_lua_win.h\" $(XP_DEFINE)

CXXDEBUG=-Od -MTd -DDEBUG -EHa
# Don't use "-MD", even with "-D_STATIC_CPPLIB" because it links to MSVCR71.DLL
CXXNDEBUG=-O1 -Oi -MT -DNDEBUG -GL -EHsc 
NAME=-Fo
LDFLAGS=-OPT:REF -DEBUG $(XP_LINK)
#-LTCG
...
!IFNDEF NO_LUA
LUA_CORE_OBJS = lapi.obj lcode.obj ldebug.obj ldo.obj ldump.obj lfunc.obj lgc.obj llex.obj lmem.obj lobject.obj lopcodes.obj lparser.obj lstate.obj lstring.obj ltable.obj ltm.obj lundump.obj lvm.obj lzio.obj
...
#scintillua print.obj lpcap.obj lpcode.obj lpprint.obj lptree.obj lpvm.obj 
