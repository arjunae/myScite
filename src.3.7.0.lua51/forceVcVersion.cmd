...
REM Provides a specific Visual Studio Build Environment. Requires only a version Number aks 14.0
REM Sets vars: VCINSTALLDIR, VS[xx]COMMNTOOLS, VisualStudioVersion WindowsLibPath , WindowsSdkDir , WindowsSDKLibVersion, WindowsSDKVersion
REM
REM USAGE: 
REM		force_vc_version.cmd (VC Version)
REM		force_vc_version.cmd 14.0
REM		%VCINSTALLDIR%\vcvarsall.bat x86
REM
