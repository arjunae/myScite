...
:sub_create_file
	...
	set scite_path_escaped=%scite_path:\=\\%

	set RegFile=%tmp_dir%\scite_install.reg
	set file_namepath=\"%scite_path_escaped%\\%file_name%\"  
	...
	echo @="%scite_path_escaped%\\%file_name%,0" >> %RegFile%
	echo. >> %RegFile%
	...
	echo "Path"="%file_namepath%" >> %RegFile%
	echo. >> %RegFile%
