...
CXXFLAGS=-Zi -TP -MP -W4 -EHs -Zc:forScope -Zc:wchar_t -D_CRT_SECURE_NO_DEPRECATE=1 -D_CRT_NONSTDC_NO_DEPRECATE $(WIDEFLAGS) $(XP_DEFINE)
...
NAME=-Fo
LDFLAGS=-OPT:REF /LTCG -RELEASE $(XP_LINK) 
LDDEBUG=-OPT:REF -DEBUG $(XP_LINK) 
