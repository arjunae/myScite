...
LUADLL=$(DIR_BIN)\lua.dll
LUALIB=$(DIR_BIN)\lua.lib
...
CXXFLAGS=-Zi -TP -MP -W3 -EHsc /std:c++17 $(CRTFLAGS) 
CXXDEBUG=-Od -MTd -DDEBUG
CXXNDEBUG=-O1 -MT -DNDEBUG
NAME=-Fo
LDFLAGS=-OPT:REF  -IGNORE:4197
#-LTCG -IGNORE:4049 #because lua uses __declspec(dllexport)
LDDEBUG=/DEBUG:FULL
...
CCFLAGS= -DLPEG_DEBUG /GS /W3 /MTd  /EHsc /Od $(CRTFLAGS) 
LDFLAGS=$(LDDEBUG) $(LDFLAGS)
!ELSE
CXXFLAGS=/GS /W3 /MT /O1 -EHsc $(CRTFLAGS) 
!ENDIF
