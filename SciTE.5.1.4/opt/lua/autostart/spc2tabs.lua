...
-- Version: 2020-14-04 heavily enhanced by ThorstenKani arjunae@nurfuerspam.de
-- based on toTabs.lua

-- Main function triggered on a specific keypress (key code 18)
function spc2tabs(key)
    ...
    editor:EndUndoAction()  -- End batch undo
end
