...
void SetDefaultDirectory(bpstd::string_view directory);
...
bool Load(bpstd::string_view sharedLibraryPaths);

Scintilla::ILexer5 *MakeLexer(bpstd::string_view languageName);
